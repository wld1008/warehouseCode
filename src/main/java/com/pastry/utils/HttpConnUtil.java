...
//                }
    ...
    public static void main(String[] args) throws Exception{
        ...
        nameValuePairs.add(new BasicNameValuePair("type","yunda"));
        nameValuePairs.add(new BasicNameValuePair("postid","3834407118365"));
        nameValuePairs.add(new BasicNameValuePair("temp",TEMP));
        String expTrack =  HttpConnUtil.sendGet("https://www.kuaidi100.com/query",nameValuePairs);
        System.out.println(expTrack);
        JSONObject jsonObject = null;
        jsonObject = JSONObject.parseObject(expTrack);
